...
def run():
    ...
    def onClick(e):
        ...
        if obj != None:
            body = p.bodies[
                obj.index
            ]  # each sphere has a index attribute wich points to the planets position in the bodies list
    ...
    time_label = label(
        ...
        pixel_pos=True,
        align="left",
        text="Time: " + str(p.current_time / 365) + " years",
    )

    ### info box ###
    info_label = label(
        pos=vector(20, scene.height / 3, 0),
        pixel_pos=True,
        box=False,
        align="left",
        text="",
